...
if((i < len)){
var k = (ks[i]);
var G__36302 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36303 = (i + (1));
m = G__36302;
i = G__36303;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36304 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__36304) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__36304));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36306 = c;
var G__36306__$1 = (((G__36306 == null))?null:G__36306.prototype);
if((G__36306__$1 == null)){
return null;
} else {
return (G__36306__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36308 = c;
var G__36308__$1 = (((G__36308 == null))?null:G__36308.prototype);
if((G__36308__$1 == null)){
return null;
} else {
return (G__36308__$1["render"]);
}
})() == null)))));
});
...
var G__36310 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36310) : reagent.impl.component.as_element.call(null,G__36310));
};
...
var _STAR_current_component_STAR__orig_val__36316 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36317 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36317;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36316;
}});
...
return ((function (G__36318,G__36318__$1){
...
var c = this;
var G__36323_36325 = (c["cljsRatom"]);
if((G__36323_36325 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36323_36325);
}
...
var renders_36327 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_36328 = cljs.core.first(cljs.core.vals(renders_36327));
if((cljs.core.count(renders_36327) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36327))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36328)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36328], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36326 = name;
switch (G__36326) {
case "":
...
var G__36331 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__36331) : reagent.impl.component.global$module$create_react_class.call(null,G__36331));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__36332 = fiber;
var G__36332__$1 = (((G__36332 == null))?null:(G__36332["type"]));
if((G__36332__$1 == null)){
return null;
} else {
return (G__36332__$1["displayName"]);
}
})();
var parent = (function (){var G__36333 = fiber;
if((G__36333 == null)){
return null;
} else {
return (G__36333["return"]);
}
})();
var path = (function (){var G__36334 = parent;
var G__36334__$1 = (((G__36334 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36334) : reagent.impl.component.fiber_component_path.call(null,G__36334)));
if((G__36334__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36334__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = (function (){var G__36336 = c;
if((G__36336 == null)){
return null;
} else {
return (G__36336["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__36337._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__36339 = c;
if((G__36339 == null)){
return null;
} else {
return (G__36339["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__36341 = c;
if((G__36341 == null)){
return null;
} else {
return G__36341._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__36343 = instance;
if((G__36343 == null)){
return null;
} else {
return (G__36343["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__36344 = instance;
if((G__36344 == null)){
return null;
} else {
return G__36344._currentElement;
}
}
})();
var name = (function (){var G__36345 = elem;
var G__36345__$1 = (((G__36345 == null))?null:(G__36345["type"]));
if((G__36345__$1 == null)){
return null;
} else {
return (G__36345__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__36347 = elem;
if((G__36347 == null)){
return null;
} else {
return (G__36347["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__36348._owner;
}
}
})();
var path = (function (){var G__36349 = owner;
var G__36349__$1 = (((G__36349 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36349) : reagent.impl.component.component_path.call(null,G__36349)));
if((G__36349__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36349__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36350 = c;
var G__36350__$1 = (((G__36350 == null))?null:G__36350.constructor);
if((G__36350__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36350__$1);
}
}
})();
