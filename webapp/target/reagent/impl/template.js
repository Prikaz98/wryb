...
var G__36368 = o;
(G__36368[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36372 = o;
(G__36372[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36373__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__36373 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__36374__i = 0, G__36374__a = new Array(arguments.length -  0);
while (G__36374__i < G__36374__a.length) {G__36374__a[G__36374__i] = arguments[G__36374__i + 0]; ++G__36374__i;}
  args = new cljs.core.IndexedSeq(G__36374__a,0,null);
} 
return G__36373__delegate.call(this,args);};
G__36373.cljs$lang$maxFixedArity = 0;
G__36373.cljs$lang$applyTo = (function (arglist__36375){
var args = cljs.core.seq(arglist__36375);
return G__36373__delegate(args);
});
...
var G__36377 = props;
var G__36377__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36377,cljs.core.cst$kw$id,id):G__36377);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36377__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36378){
...
var props = map__36379__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36379__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__36379,map__36379__$1,props,class$){
return (function (c){
...
});})(map__36379,map__36379__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36381){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36382__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__36382,map__36382__$1,on_write){
return (function (){
...
});})(node_value,map__36382,map__36382__$1,on_write))
);
} else {
...
var G__36385 = jsprops;
(G__36385["defaultValue"] = value);

(G__36385["onChange"] = ((function (G__36385,v,value,on_change){
return (function (p1__36384_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36384_SHARP_);
});})(G__36385,v,value,on_change))
);
...
var vec__36388 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36388,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36388,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36388,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___36392 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___36392 == null)){
} else {
var key_36393 = temp__5724__auto___36392;
(jsprops["key"] = key_36393);
}
...
var temp__5724__auto___36394 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___36394 == null)){
} else {
var key_36395 = temp__5724__auto___36394;
reagent.impl.template.oset(jsprops,"key",key_36395);
}
...
var G__36396 = reagent.impl.template.__GT_NativeWrapper();
(G__36396["name"] = c);
...
var G__36397 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36397) : reagent.impl.template.as_element.call(null,G__36397));
} else {
...
var len__4641__auto___36402 = arguments.length;
var i__4642__auto___36403 = (0);
while(true){
if((i__4642__auto___36403 < len__4641__auto___36402)){
args__4647__auto__.push((arguments[i__4642__auto___36403]));

var G__36404 = (i__4642__auto___36403 + (1));
i__4642__auto___36403 = G__36404;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36400){
var G__36401 = cljs.core.first(seq36400);
var seq36400__$1 = cljs.core.next(seq36400);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36401,seq36400__$1);
});
...
break;
default:
var G__36407 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36407;
continue;
...
var n__4518__auto___36409 = a.length;
var i_36410 = (0);
while(true){
if((i_36410 < n__4518__auto___36409)){
(a[i_36410] = reagent.impl.template.as_element((a[i_36410])));

var G__36411 = (i_36410 + (1));
i_36410 = G__36411;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___36412 = a.length;
var i_36413 = (0);
while(true){
if((i_36413 < n__4518__auto___36412)){
var val_36414 = (a[i_36413]);
if(((cljs.core.vector_QMARK_(val_36414)) && ((reagent.impl.template.key_from_vec(val_36414) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36413] = reagent.impl.template.as_element(val_36414));

var G__36415 = (i_36413 + (1));
i_36413 = G__36415;
continue;
} else {
}
...
var ctx = ({});
var vec__36416 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36416,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36416,(1),null);
...
var G__36419 = (cljs.core.count(argv) - first_child);
switch (G__36419) {
case (0):
...
case (1):
var G__36420 = comp;
var G__36421 = jsprops;
var G__36422 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__36420,G__36421,G__36422) : reagent.impl.template.global$module$react.createElement.call(null,G__36420,G__36421,G__36422));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__36419){
