...
return (new Date(time)).toLocaleString("en-GB",(function (){var obj31437 = {"timeZone":"UTC"};
return obj31437;
})());
} else {
return null;
...
}),cljs.core.filter.call(null,(function (p1__31439_SHARP_){
return (!(cljs.core._EQ_.call(null,category_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31439_SHARP_))));
}),categories))], null);
});
...
return wryb_ui.components.task_edit.update_state.call(null,task,new cljs.core.Keyword(null,"title","title",636505583),p1__31440_SHARP_.target.value);
});})(task))
...
return wryb_ui.components.task_edit.update_state.call(null,task,new cljs.core.Keyword(null,"desc","desc",2093485764),p1__31441_SHARP_.target.value);
});})(task))
...
//# sourceMappingURL=task_edit.js.map
