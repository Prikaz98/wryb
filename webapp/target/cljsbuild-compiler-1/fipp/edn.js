...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__31169,open,xs,sep,close,f){
...
var printer = map__31170__$1;
var print_level = cljs.core.get.call(null,map__31170__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__31170__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__31172 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__31172,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__31172;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,((function (printer__$1,map__31170,map__31170__$1,printer,print_level,print_length){
return (function (p1__31168_SHARP_){
return f.call(null,printer__$1,p1__31168_SHARP_);
});})(printer__$1,map__31170,map__31170__$1,printer,print_level,print_length))
),cljs.core.interpose.call(null,sep));
var ys = ((((function (){var or__4047__auto__ = print_level;
...
var ellipsis = (cljs.core.truth_((function (){var and__4036__auto__ = print_length;
...
fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k31174,else__4304__auto__){
var self__ = this;
var this__4303__auto____$1 = this;
var G__31178 = k31174;
var G__31178__$1 = (((G__31178 instanceof cljs.core.Keyword))?G__31178.fqn:null);
switch (G__31178__$1) {
case "symbols":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k31174,else__4304__auto__);
...
return (function (ret__4323__auto__,p__31179){
var vec__31180 = p__31179;
var k__4324__auto__ = cljs.core.nth.call(null,vec__31180,(0),null);
var v__4325__auto__ = cljs.core.nth.call(null,vec__31180,(1),null);
...
;
return cljs.core.pr_sequential_writer.call(null,writer__4316__auto__,pr_pair__4318__auto__,"#fipp.edn.EdnPrinter{",", ","}",opts__4317__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"symbols","symbols",1211743),self__.symbols],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),self__.print_meta],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-length","print-length",1931866356),self__.print_length],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"print-level","print-level",-1825423733),self__.print_level],null))], null),self__.__extmap));
});

fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31173){
var self__ = this;
var G__31173__$1 = this;
return (new cljs.core.RecordIter((0),G__31173__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__31183){
var self__ = this;
...
var tag = cljs.core.get.call(null,map__31184__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__31184__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"group","group",582596132),"#",cljs.core.pr_str.call(null,tag),(cljs.core.truth_((function (){var or__4047__auto__ = (function (){var and__4036__auto__ = self__.print_meta;
if(cljs.core.truth_(and__4036__auto__)){
...
return (function (printer,p__31186){
...
fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31175,other31176){
var self__ = this;
var this31175__$1 = this;
return (((!((other31176 == null)))) && ((this31175__$1.constructor === other31176.constructor)) && (cljs.core._EQ_.call(null,this31175__$1.symbols,other31176.symbols)) && (cljs.core._EQ_.call(null,this31175__$1.print_meta,other31176.print_meta)) && (cljs.core._EQ_.call(null,this31175__$1.print_length,other31176.print_length)) && (cljs.core._EQ_.call(null,this31175__$1.print_level,other31176.print_level)) && (cljs.core._EQ_.call(null,this31175__$1.__extmap,other31176.__extmap)));
});
...
fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__31173){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__31190 = cljs.core.keyword_identical_QMARK_;
var expr__31191 = k__4309__auto__;
if(cljs.core.truth_(pred__31190.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__31191))){
return (new fipp.edn.EdnPrinter(G__31173,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31190.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__31191))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__31173,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31190.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__31191))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__31173,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31190.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__31191))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__31173,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4309__auto__,G__31173),null));
}
}
}
}
...
fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__31173){
var self__ = this;
var this__4300__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__31173,self__.__extmap,self__.__hash));
});
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__31177){
var extmap__4340__auto__ = (function (){var G__31193 = cljs.core.dissoc.call(null,G__31177,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__31177)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__31193);
} else {
return G__31193;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__31177),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__31177),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__31177),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__31177),null,cljs.core.not_empty.call(null,extmap__4340__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__31197 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__31198 = false;
cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__31198;

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__31197;
}});
