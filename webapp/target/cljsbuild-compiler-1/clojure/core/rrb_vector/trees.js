...
var G__30780 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__30781 = (shift__$2 - (5));
node__$1 = G__30780;
shift__$2 = G__30781;
continue;
}
...
var G__30783 = i__$2;
var G__30784 = (node.arr[j]);
var G__30785 = (shift__$1 - (5));
i__$1 = G__30783;
node = G__30784;
shift__$1 = G__30785;
continue;
...
var n_30790 = ret;
var shift_30791__$1 = shift;
while(true){
var arr_30792__$1 = n_30790.arr;
var subidx_30793 = (((cnt - (1)) >> shift_30791__$1) & (31));
if((shift_30791__$1 === (5))){
(arr_30792__$1[subidx_30793] = tail_node);
} else {
var temp__5718__auto___30794 = (arr_30792__$1[subidx_30793]);
if(cljs.core.truth_(temp__5718__auto___30794)){
var child_30795 = temp__5718__auto___30794;
var new_carr_30796 = cljs.core.aclone.call(null,child_30795.arr);
var new_child_30797 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_30796);
(arr_30792__$1[subidx_30793] = new_child_30797);

var G__30798 = new_child_30797;
var G__30799 = (shift_30791__$1 - (5));
n_30790 = G__30798;
shift_30791__$1 = G__30799;
continue;
} else {
(arr_30792__$1[subidx_30793] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_30791__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_30801__$1 = shift;
var node_30802__$1 = node;
while(true){
if((shift_30801__$1 === (0))){
var arr_30803 = node_30802__$1.arr;
(arr_30803[(i & (31))] = val);
} else {
var arr_30804 = node_30802__$1.arr;
var subidx_30805 = ((i >> shift_30801__$1) & (31));
var child_30806 = clojure.core.rrb_vector.nodes.clone.call(null,shift_30801__$1,(arr_30804[subidx_30805]));
(arr_30804[subidx_30805] = child_30806);

var G__30807 = (shift_30801__$1 - (5));
var G__30808 = child_30806;
shift_30801__$1 = G__30807;
node_30802__$1 = G__30808;
continue;
}
break;
}
