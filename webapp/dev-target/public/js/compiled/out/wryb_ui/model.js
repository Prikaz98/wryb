...
fetch("http://localhost:3000/categories").then((function (p1__37978_SHARP_){
return p1__37978_SHARP_.json();
})).then((function (p1__37979_SHARP_){
return cljs.core.js__GT_clj.call(null,p1__37979_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true);
})).then((function (p1__37980_SHARP_){
return cljs.core.reset_BANG_.call(null,wryb_ui.model.categories,p1__37980_SHARP_);
}));
...
return fetch(["http://localhost:3000/tasks?category=",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(category))].join('')).then((function (p1__37981_SHARP_){
return p1__37981_SHARP_.json();
})).then((function (p1__37982_SHARP_){
return cljs.core.js__GT_clj.call(null,p1__37982_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true);
})).then((function (p1__37983_SHARP_){
return cljs.core.reset_BANG_.call(null,wryb_ui.model.todos,p1__37983_SHARP_);
}));
});
...
//# sourceMappingURL=model.js.map?rel=1710956921664
