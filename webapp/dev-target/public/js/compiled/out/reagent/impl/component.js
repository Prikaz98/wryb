...
if((i < len)){
var k = (ks[i]);
var G__30234 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__30235 = (i + (1));
m = G__30234;
i = G__30235;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__30237 = c;
var G__30237__$1 = (((G__30237 == null))?null:G__30237.prototype);
if((G__30237__$1 == null)){
return null;
} else {
return (G__30237__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__30239 = c;
var G__30239__$1 = (((G__30239 == null))?null:G__30239.prototype);
if((G__30239__$1 == null)){
return null;
} else {
return (G__30239__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__30242__delegate = function (args){
...
while (G__30243__i < G__30243__a.length) {G__30243__a[G__30243__i] = arguments[G__30243__i + 0]; ++G__30243__i;}
  args = new cljs.core.IndexedSeq(G__30243__a,0,null);
} 
return G__30242__delegate.call(this,args);};
G__30242.cljs$lang$maxFixedArity = 0;
G__30242.cljs$lang$applyTo = (function (arglist__30244){
var args = cljs.core.seq(arglist__30244);
return G__30242__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__30246 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__30247 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__30247;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__30246;
}});
...
var c = this;
var G__30253_30255 = (c["cljsRatom"]);
if((G__30253_30255 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__30253_30255);
}
...
var renders_30257 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_30258 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_30257));
if((cljs.core.count.call(null,renders_30257) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_30257))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_30258)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_30258))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__30256 = name;
switch (G__30256) {
case "":
...
var G__30260 = o;
(G__30260[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__30261 = fiber;
var G__30261__$1 = (((G__30261 == null))?null:(G__30261["type"]));
if((G__30261__$1 == null)){
return null;
} else {
return (G__30261__$1["displayName"]);
}
})();
var parent = (function (){var G__30262 = fiber;
if((G__30262 == null)){
return null;
} else {
return (G__30262["return"]);
}
})();
var path = (function (){var G__30263 = parent;
var G__30263__$1 = (((G__30263 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__30263));
if((G__30263__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30263__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = (function (){var G__30265 = c;
if((G__30265 == null)){
return null;
} else {
return (G__30265["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__30266._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__30268 = c;
if((G__30268 == null)){
return null;
} else {
return (G__30268["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__30270 = c;
if((G__30270 == null)){
return null;
} else {
return G__30270._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__30272 = instance;
if((G__30272 == null)){
return null;
} else {
return (G__30272["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__30273 = instance;
if((G__30273 == null)){
return null;
} else {
return G__30273._currentElement;
}
}
})();
var name = (function (){var G__30274 = elem;
var G__30274__$1 = (((G__30274 == null))?null:(G__30274["type"]));
if((G__30274__$1 == null)){
return null;
} else {
return (G__30274__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__30276 = elem;
if((G__30276 == null)){
return null;
} else {
return (G__30276["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__30277._owner;
}
}
})();
var path = (function (){var G__30278 = owner;
var G__30278__$1 = (((G__30278 == null))?null:reagent.impl.component.component_path.call(null,G__30278));
if((G__30278__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30278__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__30279 = c;
var G__30279__$1 = (((G__30279 == null))?null:G__30279.constructor);
if((G__30279__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__30279__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1710956798688
